...
target_folder = '/Users/jonathanlifferth/Documents/Arbeit/Vanderbilt Research Analyst/' \
...
with open('master_df_0.csv', 'w') as out_file:
    ...
    for file in files:
        if file.endswith('Track statistics.csv'):
            ...
            with open(current_file, 'r') as in_file:
                next(in_file)
                for line in in_file:
                    with open('master_df_0.csv', 'a') as out_file:
